    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-20">
        ...
        <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.1] mb-6">
          ...
          <br />
          <em className="not-italic text-[#C9A84C] italic">Für Generationen.</em>
        </h1>

        {/* Subtext */}
        <p className="max-w-2xl mx-auto text-gray-400 text-lg sm:text-xl leading-relaxed mb-12">
        ...
        {/* Trust strip */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 pt-8 border-t border-white/5 text-sm text-gray-500">
          <TrustItem
            icon={
